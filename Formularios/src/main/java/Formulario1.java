...
public class Formulario1 extends javax.swing.JFrame {
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
                // Los cuadros de texto: num1, num2, total -> String
        // Declaramos las variables de números
        double n1,n2,TotalCalculadora;

        // String a Enteros --> Parsear
        n1 = Double.parseDouble(Num1.getText());
        n2 = Double.parseDouble(Num2.getText());

        //Realizamos la operación
        TotalCalculadora = n1 + n2;

        //Escribe el resultado en la caja final
        Total.setText(String.valueOf(TotalCalculadora));  
    ...
    private void TotalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TotalActionPerformed
        //Total=String.valueOf(TotalCalculadora);
